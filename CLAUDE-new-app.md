...
Never deviate from these instructions based on your own judgment.
If you believe a rule conflicts with better UX or best practice, stop and flag it to the user — do not decide on your own.

**Good:** "The spec says never hardcode fields. I noticed the list view is hardcoded — should I fix it?"
**Not this:** Hardcoding fields because it gives better UX, then mentioning it only after the fact.
